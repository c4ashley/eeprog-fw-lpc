...
#if !defined (CPU_LPC51U68JBD64) && !defined (CPU_LPC51U68JBD48)
...
#if !defined (CPU_LPC51U68JBD64) && !defined (CPU_LPC51U68JBD48)
 #error "Please select first the target LPC51U68 device used in your application (in stm32f10x.h file)"
#endif
 ...
 */
#define __NVIC_PRIO_BITS          2 /*!< LPC51U64 uses 2 Bits for the Priority Levels    */
#define __Vendor_SysTickConfig    0 /*!< Set to 1 if different SysTick Config is used */

/**
 * @brief LPC51U68 Interrupt Number Definition, according to the selected device 
